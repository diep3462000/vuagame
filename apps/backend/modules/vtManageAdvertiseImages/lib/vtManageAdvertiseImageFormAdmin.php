 ...
 */
class vtManageAdvertiseImageFormAdmin extends BaseVtpAdvertiseImageForm
{
    public function configure()
    {
        unset($this['created_by'], $this['updated_by'], $this['created_at'], $this['updated_at']);
        $adId= sfContext::getInstance()->getUser()->getAttribute('vtManageAdvertiseImages.adid', -1, 'admin_module');
