...
/**
 * VtpAdvertiseImage filter form base class.
 *
 * @package    Vt_Portals
 * @subpackage filter
 * @author     ngoctv1
 ...
 */
abstract class BaseVtpAdvertiseImageFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'advertise_id' => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('VtpAdvertiseImage'), 'column' => 'id')),
    ...
    $this->widgetSchema->setNameFormat('vtp_advertise_image_filters[%s]');
