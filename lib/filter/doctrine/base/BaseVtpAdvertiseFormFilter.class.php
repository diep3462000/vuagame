...
/**
 * VtpAdvertise filter form base class.
 *
 * @package    Vt_Portals
 * @subpackage filter
 * @author     ngoctv1
 ...
 */
abstract class BaseVtpAdvertiseFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('vtp_advertise_filters[%s]');
