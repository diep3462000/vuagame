...
/**
 * VtpAdvertiseImage form base class.
 *
 * @method VtpAdvertiseImage getObject() Returns the current form's model object
 *
 * @package    Vt_Portals
 * @subpackage form
 * @author     ngoctv1
 ...
 */
abstract class BaseVtpAdvertiseImageForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'advertise_id' => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('VtpAdvertiseImage'), 'add_empty' => true)),
    ...
    $this->setValidators(array(
      ...
      'advertise_id' => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('VtpAdvertiseImage'), 'required' => false)),
    ...
    $this->widgetSchema->setNameFormat('vtp_advertise_image[%s]');
